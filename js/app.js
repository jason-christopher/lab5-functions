...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let firstArrSum = sum(a, b)[0];
  let totalSum = sum(firstArrSum, c)[0];
  let firstArrProd = multiply(a, b)[0];
  let totalProd = multiply(firstArrProd, c)[0];
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let totalSum = sum(firstArrSum, sumArr[2])[0];
...
function multiplyArray(multArr) { //eslint-disable-line
  let firstArrProd = multiply(multArr[0], multArr[1])[0];
  let totalProd = multiply(firstArrProd, multArr[2])[0];
  return [totalProd, `The numbers ${multArr} have a product of ${totalProd}.`];
}
